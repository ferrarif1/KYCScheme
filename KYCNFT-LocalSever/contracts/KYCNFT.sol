...
contract KYCNFT is ERC721URIStorage, Ownable {
    ...
    mapping(uint256 => uint256) public NFTID_To_ExpirationTime;

    //set this first!
    function setKYManagerContractAddress(address _kycManagerAddr)
        public
        onlyOwner
    {
    ...
    function updateExpirationTime(uint256 tokenId, uint256 timestamp)
        external
        onlyKycManagerContractAddress
    {
    ...
    function expirationTimeOfNFTId(uint256 tokenId)
        public
        view
        returns (uint256)
    {
